 ...
 * 
 */
public class PlasmaPoleScene extends AbstractScene{
	...
	public PlasmaPoleScene(MTApplication mtApplication, String name) {
        ...
        pong = new SoundPoleGame(mtApplication, fluidSolver);
